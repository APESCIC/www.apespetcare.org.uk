...
$releaseEntries = [
    ...
    [
        ...
        'types' => 'changed fixed',
        'pills' => [
            ['class' => 'pill-version', 'label' => 'Version v0.5.1b'],
            ['class' => 'pill-status', 'label' => 'Beta'],
            ['class' => 'pill-type', 'label' => 'Changed'],
            ['class' => 'pill-type', 'label' => 'Fixed'],
            ['class' => 'pill-fix', 'label' => 'Integration Fix'],
            ['class' => 'pill-fix', 'label' => 'Layout Fix'],
        ],
        'summary' => 'Removed the broken embedded booking form from the public bookings page, switched booking and pre-pay links to shared popup-window behaviour with a safe fallback, and fixed card and CTA spacing issues affecting the homepage and Services Hub.',
        'details' => [
        ...
        'typePills' => [
            ['class' => 'pill-type', 'label' => 'Changed', 'description' => 'Reworked the public bookings page into a non-embedded booking guidance page and moved shared external workflow links onto one popup-window pattern.'],
            ['class' => 'pill-type', 'label' => 'Fixed', 'description' => 'Corrected the broken booking embed, the overflowing Services Hub payment-card content, and the homepage Before you pay CTA overlap.'],
        ],
        'fixPills' => [
            ['class' => 'pill-fix', 'label' => 'Integration Fix', 'description' => 'Booking and Stripe pre-pay journeys now share consistent popup-window handling with safe new-tab fallback when popups are blocked.'],
            ['class' => 'pill-fix', 'label' => 'Layout Fix', 'description' => 'Pre-pay cards now keep long text inside card bounds and the homepage CTA spacing no longer collides with the warning panel.'],
        ],
        'affectedAreas' => [
            'Website' => 'APES Pet Care Clinic public website.',
    ...
    [
        'version' => 'v0.5.0b',
        'date' => '2026-06-02',
        'title' => 'Care Plans pricing table and card-led page refresh',
        'status' => 'Beta',
        'statusKey' => 'beta',
        'current' => false,
        'impact' => 'public-facing operational',
        ...
        'pills' => [
            ['class' => 'pill-version', 'label' => 'Version v0.5.0b'],
            ['class' => 'pill-status', 'label' => 'Beta'],
        ...
        'summary' => 'Added the supplied Stripe Care Plan Pricing Table to the public Care Plans page and restructured the page into a clearer card-led journey so visitors can compare options, review suitability guidance, and contact the clinic before paying where needed.',
        'details' => [
            'Reworked the /care-plans/ page order so visitors now see a plan overview first, the live pricing table second, supporting plan information in a responsive card grid, and a final safety and contact card at the end of the main content.',
        ...
        'typePills' => [
            ['class' => 'pill-type', 'label' => 'Added', 'description' => 'Introduced the live Care Plan Stripe pricing table and supporting fallback guidance on /care-plans/.'],
            ['class' => 'pill-type', 'label' => 'Changed', 'description' => 'Reordered the page into a clearer pricing-first card journey and refined the Care Plans route copy and metadata.'],
            ['class' => 'pill-type', 'label' => 'Fixed', 'description' => 'Reduced ambiguity in the plan-join journey by placing pricing, suitability guidance, and contact fallback in a clearer sequence.'],
        ],
        'fixPills' => [
            ['class' => 'pill-fix', 'label' => 'Integration Fix', 'description' => 'The supplied Stripe pricing table is now embedded directly on the Care Plans page without adding Stripe scripts to shared site templates.'],
            ['class' => 'pill-fix', 'label' => 'Content Fix', 'description' => 'Visitors now see plan comparison, exclusions, and next-step guidance in one route instead of needing to infer pricing from generic page copy alone.'],
        ],
        'affectedAreas' => [
            'Website' => 'APES Pet Care Clinic public website.',
        ...
        'validation' => [
            ...
            'Manual checks completed' => 'Confirmed by source inspection that the page order now follows overview, pricing table, supporting info cards, and final safety and contact guidance, and that both changelog records plus VERSION now reference v0.5.0b.',
    ...
    [
        'version' => 'v0.4.0b',
        'date' => '2026-06-02',
        'title' => 'Beta audit remediation and safer payment journey hardening',
        'status' => 'Beta',
        'statusKey' => 'beta',
        'current' => false,
        'impact' => 'public-facing operational compliance accessibility seo',
        'types' => 'added changed fixed compliance accessibility seo',
        'pills' => [
            ['class' => 'pill-version', 'label' => 'Version v0.4.0b'],
            ['class' => 'pill-status', 'label' => 'Beta'],
            ['class' => 'pill-type', 'label' => 'Added'],
            ['class' => 'pill-type', 'label' => 'Changed'],
            ['class' => 'pill-type', 'label' => 'Fixed'],
            ['class' => 'pill-compliance', 'label' => 'Compliance'],
            ['class' => 'pill-fix', 'label' => 'Accessibility Fix'],
            ['class' => 'pill-fix', 'label' => 'SEO Fix'],
        ],
        'summary' => 'Completed a beta audit-hardening release that reframes clinically sensitive public wording, moves pre-payment into a safer Services Hub journey, replaces encoded-space routes with clean canonical routes, and adds the metadata, sitemap, robots, and payment-audit records needed for a more maintainable public website.',
        'details' => [
        ...
        'typePills' => [
            ['class' => 'pill-type', 'label' => 'Added', 'description' => 'Introduced the new /services/ hub, canonical /care-plans/ and /lab-services/ routes, robots.txt, sitemap.xml, and the PAYMENT_LINK_AUDIT.md governance record.'],
            ['class' => 'pill-type', 'label' => 'Changed', 'description' => 'Reworked shared payment wording, public clinic-scope copy, navigation behaviour, metadata, sitemap records, and route references across the site.'],
            ['class' => 'pill-type', 'label' => 'Fixed', 'description' => 'Removed the duplicated general-services payment block, fixed encoded-route references, corrected the care-plans mojibake, and standardised UK spelling and sentence case in the audited templates.'],
            ['class' => 'pill-compliance', 'label' => 'Compliance', 'description' => 'Hardened clinically sensitive public wording and pre-payment messaging so APES is framed as first aid, welfare support, and referral triage only.'],
        ],
        'fixPills' => [
            ['class' => 'pill-fix', 'label' => 'Accessibility Fix', 'description' => 'Payment links now keep unique accessible labels, decorative hero logos use empty alt text, menu triggers have clearer focus treatment, and the Change Log Hub accessibility baseline remains intact.'],
            ['class' => 'pill-fix', 'label' => 'SEO Fix', 'description' => 'Canonical metadata, Open Graph and Twitter metadata, robots, sitemap, and clean canonical routes are now aligned around the live public pages.'],
        ],
        'affectedAreas' => [
            'Website' => 'APES Pet Care Clinic public website.',
        ...
        'versionDecision' => [
            ...
            'New version' => 'v0.4.0b',
            'Version type' => 'Beta minor release',
            'Reason for version bump' => 'This release adds a new Services Hub and canonical routes while materially reworking public payment journeys, compliance wording, metadata, and accessibility and SEO support across existing pages without changing the site platform.',
        ],
        'validation' => [
            ...
            'Rollback notes' => 'Revert the shared payment and metadata helpers, route redirects, new canonical route pages, policy and template rewrites, sitemap and robots and payment-audit files, VERSION file, and both changelog entries to restore the previous v0.3.2 public release state.',
        ],
    ],
    [
        'version' => 'v0.3.2',
    ...
    [
        ...
        'types' => 'changed fixed',
        'pills' => [
            ['class' => 'pill-version', 'label' => 'Version v0.1.1'],
            ['class' => 'pill-status', 'label' => 'Stable'],
            ['class' => 'pill-type', 'label' => 'Changed'],
            ['class' => 'pill-type', 'label' => 'Fixed'],
            ['class' => 'pill-fix', 'label' => 'Integration Fix'],
        ...
        'summary' => 'Updated the global Chatwoot live chat integration to use the supplied website token and launcher configuration so the website shows the new right-hand expanded support bubble consistently.',
        'details' => [
        ...
        'typePills' => [
            ['class' => 'pill-type', 'label' => 'Changed', 'description' => 'Updated the shared live chat configuration used across public website pages.'],
            ['class' => 'pill-type', 'label' => 'Fixed', 'description' => 'Corrected the launcher behaviour and account connection details so the website points at the supplied Chatwoot workspace and presents the requested copy.'],
        ],
        'fixPills' => [
            ['class' => 'pill-fix', 'label' => 'Integration Fix', 'description' => 'The shared Chatwoot SDK bootstrap now uses the supplied website token and launcher settings without duplicating the script.'],
            ['class' => 'pill-fix', 'label' => 'Content Fix', 'description' => 'The live chat launcher title now reads Speak with an advisor instead of the previous incorrect wording.'],
        ],
        'affectedAreas' => [
            'Website' => 'APES Pet Care Clinic public website.',
    ...
    [
        'version' => 'v0.1.0',
        'date' => '2026-06-02',
        'title' => 'Stripe pre-pay booking flow for clinic services',
        'status' => 'Stable',
        'statusKey' => 'stable',
        'current' => false,
        'impact' => 'public-facing operational',
        'types' => 'added changed fixed',
        'pills' => [
            ['class' => 'pill-version', 'label' => 'Version v0.1.0'],
            ['class' => 'pill-status', 'label' => 'Stable'],
            ['class' => 'pill-type', 'label' => 'Added'],
            ['class' => 'pill-type', 'label' => 'Changed'],
            ['class' => 'pill-type', 'label' => 'Fixed'],
        ...
        'summary' => 'Added a shared Stripe pre-pay service catalogue and surfaced the new pre-pay and book flow across the clinic services landing page plus the relevant species and general service detail pages.',
        'details' => [
        ...
        'typePills' => [
            ['class' => 'pill-type', 'label' => 'Added', 'description' => 'Introduced a shared pre-pay service catalogue and a new full landing-page payment section for clinic services.'],
            ['class' => 'pill-type', 'label' => 'Changed', 'description' => 'Updated multiple clinic service detail pages to surface contextual Stripe pre-pay CTAs and aligned pricing copy.'],
            ['class' => 'pill-type', 'label' => 'Fixed', 'description' => 'Corrected the public booking journey so customers can pay for supported services before following the booking instructions shown after payment.'],
        ],
        'fixPills' => [
            ['class' => 'pill-fix', 'label' => 'Content Fix', 'description' => 'Service pages now show exact pre-pay service names, prices, and booking guidance for supported Stripe-linked offers.'],
            ['class' => 'pill-fix', 'label' => 'Integration Fix', 'description' => 'Hosted Stripe payment links are now surfaced directly from the relevant clinic service routes without introducing custom payment logic.'],
        ],
        'affectedAreas' => [
            'Website' => 'APES Pet Care Clinic public website.',
